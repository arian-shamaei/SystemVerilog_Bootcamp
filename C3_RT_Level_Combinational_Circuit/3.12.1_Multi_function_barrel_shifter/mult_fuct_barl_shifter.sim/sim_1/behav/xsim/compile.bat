...
REM
REM Generated by Vivado on Wed Aug 06 17:32:00 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj one_shift_32_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj one_shift_32_testbench_vlog.prj -log xvlog.log
