...
REM
REM Generated by Vivado on Sun Aug 03 18:13:29 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj one_shift_lr_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj one_shift_lr_testbench_vlog.prj -log xvlog.log
