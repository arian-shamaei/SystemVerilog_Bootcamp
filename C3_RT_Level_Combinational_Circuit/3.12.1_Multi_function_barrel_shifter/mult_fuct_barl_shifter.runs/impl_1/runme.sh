...
HD_PWD='C:/Xilinx/FPGA_Prototyping_by_SystemVerilog_Examples/C3_RT_Level_Combinational_Circuit/3.12.1_Multi_function_barrel_shifter/mult_fuct_barl_shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_shift_flip_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_shift_flip_32.tcl -notrace
