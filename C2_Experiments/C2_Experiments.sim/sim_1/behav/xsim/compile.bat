...
REM
REM Generated by Vivado on Wed Jul 23 18:11:21 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj gt2_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj gt2_testbench_vlog.prj -log xvlog.log
