...
REM
REM Generated by Vivado on Sat Jul 26 22:39:51 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj gt4_testbench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj gt4_testbench_vlog.prj -log xvlog.log
