...
HD_PWD='C:/Users/arianshamaei/Verification_Engineering/FPGA_Prototyping_by_SystemVerilog_Examples/C2_Experiments/C2_Experiments.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gt4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gt4.tcl -notrace
