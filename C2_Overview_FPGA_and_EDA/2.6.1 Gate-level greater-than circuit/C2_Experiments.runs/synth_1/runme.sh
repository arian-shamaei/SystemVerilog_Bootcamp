...
HD_PWD='C:/Users/arianshamaei/Verification_Engineering/FPGA_Prototyping_by_SystemVerilog_Examples/C2_Experiments/C2_Experiments.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gt4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gt4.tcl
